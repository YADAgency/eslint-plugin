...
module.exports = {
  ...
  create: function(context) {
    const propMatch = /(width|height|margin(-(top|bottom|left|right))?|padding(-(top|bottom|left|right))?|border-radius(-(top-left|top-right|bottom-left|bottom-right))?|top|left|right|bottom|font-size):\s*-?(?![0])\d+(?!(px|%|em|rem|vh|vw));/gm
